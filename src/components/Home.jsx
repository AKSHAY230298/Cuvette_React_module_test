...
import banner from '../assets/mainPageImage.png';
import lock from '../assets/vectorLock.png';
import pluse from '../assets/addBtn.png';
import './Home.css';
  ...
  return (
    <>
      {screenSize.width < 989 ? (
        <div className="PocketNoteBarContainerMobile">
          {groupSelect ? (
            <Notes
            ...
            <>
              ...
              <img src={pluse} className="CreateButton" onClick={() => setOpenModal(true)}>
        ...
        <>
          <div className="PocketNoteBarContainer">
